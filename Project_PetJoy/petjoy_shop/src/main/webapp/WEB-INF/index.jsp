                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                ...
                                <button class="btn btn-outline-success c-white b-white" type="submit"
                                    data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-cart4"></i>
                                    <span class="badge bg-success rounded-pill">5</span> <strong>$ 0</strong></button>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="d-flex flex-wrap justify-content-between">
                    <div class="card m-1" style="max-width: 18rem;">
                        <div class="card-header d-flex justify-content-center align-self-cente">
                            <img src="./img/Pedigree.png" alt="Pedigree" height="150px">
                    ...
                    <div class="card m-1" style="max-width: 18rem;">
                        <div class="card-header d-flex justify-content-center align-self-cente">
                            <img src="./img/CatChow.png" alt="CatChow" height="150px">
                            <i class="bi bi-search"></i>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Lorem ipsum</h5>
                    ...
                    <div class="card m-1" style="max-width: 18rem;">
                        <div class="card-header d-flex justify-content-center align-self-cente">
                            <img src="./img/Juguete.png" alt="Juguete" height="150px">
                            <i class="bi bi-search"></i>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Lorem ipsum</h5>
                    ...
                    <div class="card m-1" style="max-width: 18rem;">
                        <div class="card-header d-flex justify-content-center align-self-cente">
                            <img src="./img/Juguete2.png" alt="Juguete2" height="150px">
                            <i class="bi bi-search"></i>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Lorem ipsum</h5>
                ...
                <section class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                            ...
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad, eligendi accusamus nemo
                                natus
