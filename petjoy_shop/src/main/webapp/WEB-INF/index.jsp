    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="mt-4">
            ...
            <div class="d-flex flex-wrap justify-content-between">
                <div class="card m-1" style="max-width: 18rem;">
                    <div class="card-header d-flex justify-content-center align-self-cente">
                        <img src="./img/product1.png" alt="Pedigree" height="150px">
                        <i class="bi bi-search"></i>
                    </div>
                    <div class="card-body">
                ...
                <div class="card m-1" style="max-width: 18rem;">
                    <div class="card-header d-flex justify-content-center align-self-cente">
                        <img src="./img/product2.png" alt="CatChow" height="150px">
                        <i class="bi bi-search"></i>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Lorem ipsum</h5>
                ...
                <div class="card m-1" style="max-width: 18rem;">
                    <div class="card-header d-flex justify-content-center align-self-cente">
                        <img src="./img/product3.png" alt="Juguete" height="150px">
                        <i class="bi bi-search"></i>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Lorem ipsum</h5>
                ...
                <div class="card m-1" style="max-width: 18rem;">
                    <div class="card-header d-flex justify-content-center align-self-cente">
                        <img src="./img/product4.png" alt="Juguete2" height="150px">
                        <i class="bi bi-search"></i>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Lorem ipsum</h5>
