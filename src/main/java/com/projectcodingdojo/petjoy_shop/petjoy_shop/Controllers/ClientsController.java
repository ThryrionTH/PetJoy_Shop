...
public class ClientsController {
    ...
    public String updateClients(@Valid @ModelAttribute("client") Clients client, HttpSession session, BindingResult result) {
        Long client_id = (Long) session.getAttribute("client_id");
...
//         } catch (Exception e) {
//             // Manejar la excepción, imprimir mensajes de error o redirigir a una página de error.
